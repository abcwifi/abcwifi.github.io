...
<div class="card-header">
	<h3><i class=" fa fa-money"></i> Cek Aktivasi Voucher <?= ucfirst($idhr) . ucfirst(substr($idbl,0,3).' '.substr($idbl,3,5));	if ($prefix != "") {echo " prefix [" . $prefix . "]";} ?> <small id="loader" style="display: none;" ><i><i class='fa fa-circle-o-notch fa-spin'></i> <?= $_processing ?> </i></small></h3>
</div>
<div class="row">
	<div class="row">
	<div class="col-12">

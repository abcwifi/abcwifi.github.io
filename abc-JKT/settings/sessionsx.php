...
// array color
  ...
  $gen = '<?php $qrbt="' . $qrbt . '";?>';
          ...
          $data = $gen;
          fwrite($handle, $data);
    echo "<script>window.location='./cek.php?id=sessions'</script>";
  }
	...
	<div class="col-12">
  	<div class="card">
  		<div class="card-header">
  			<h3 class="card-title"><i class="fa fa-gear"></i> <?= info ?> &nbsp; | &nbsp;&nbsp;<i onclick="location.reload();" class="fa fa-refresh pointer " title="Reload data"></i></h3>
  		</div>
      <div class="card-body">
        <div class="row">
          <div class="col-6">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><i class="fa fa-server"></i> Klik Cek Voucher di bawah ini :</h3>
              </div>
            <div class="card-body">
            <div class="row">
              <?php
                        ...
                        <div class="box bmh-75 box-bordered <?= $color[rand(1, 11)]; ?>">
                                <div class="box-group">
                                  ...
                                  <div class="box-group-area">
                                    <span>
                                      <span class="connect pointer"  id="<?= $value; ?>"><i class="fa fa-external-link"></i> Cek Voucher</span>&nbsp;
          ...
          <form autocomplete="off" method="post" action="">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><i class="fa fa-user-circle"></i> info Versi</h3>
              </div>
            <div class="card-body">
      <table class="table table-sm">
        <tr>
          <td class="align-middle"><?= Router ?> </td><td><input class="form-control" id="useradm" type="text" size="10" name="useradm"  value="<?= $useradm; ?>" required="1"/></td>
        </tr>
        <tr>
        ...
        <tr>
          <td></td><td class="text-right">
              <div class="input-group-4">
                  <input class="group-item group-item-l" type="submit" style="cursor: pointer;" name="save" value="Version"/>
...
<a href="./cek.php?id=settings&session=<?= $value; ?>"><i class="fa fa-edit"></i> <?= setting ?></a>&nbsp;
    </div>
    </div>
    </form>
  </div>

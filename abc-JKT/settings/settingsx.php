...
if (!isset($_SESSION["mikhmon"])) {
  ...
  if ($id == "settings" && explode("-",$router)[0] == "new") {
    ...
    echo "<script>window.location='./cek.php?id=settings&session=" . $router . "'</script>";
  }
  ...
  if (isset($_POST['save'])) {
    ...
    $_SESSION["connect"] = "";
    echo "<script>window.location='./cek.php?id=settings&session=" . $sesname . "'</script>";
  }
  if ($currency == "") {
    echo "<script>window.location='./cek.php?id=settings&session=" . $session . "'</script>";
  }
}
?>
<script>
        ...
        <div class="card-body">
    	   <div class="row">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table class="table">
                    <tr>
                      <td>Server info</td>
                      <td><input class="form-control" id="sessname" type="text" name="sessname" value="<?php if (explode("-",$session)[0] == "new") {
                                                                                                                              echo "";
                                                                                                                            } else {
                                                                                                                              echo $session;
                                                                                                                            } ?>" required="1"/></td>
            ...
            <div class="col-12">
				      <div class="card">
        	     <div class="card-header">
            	   <h3 class="card-title">Router <?= $_SESSION["connect"]; ?></h3>
        	     </div>
        	     <div class="card-body">
				<table class="table table-sm">
					<tr>
	  					<td class="align-middle">IP Router </td><td><input class="form-control" type="text" size="15" name="ipmik"  value="<?= $iphost; ?>" required="1"/></td>
					</tr>
					<tr>
						<td class="align-middle">Username  </td><td><input class="form-control" id="usermk" type="text" size="10" name="usermik"  value="<?= $userhost; ?>" required="1"/></td>
					</tr>
					<tr>
						<td class="align-middle">Password  </td><td>
							<div class="input-group">
								<div class="input-group-11 col-box-10">
        						<input class="group-item group-item-l" id="passmk" type="password" name="passmik"  value="<?= decrypt($passwdhost); ?>" required="1"/>
        						</div>
            					</div>
    						</div>
						</td>
...
<div class="col-12">
	...
	<table class="table table-sm">
	<tr>
	<td class="align-middle">Status  </td><td><input class="form-control" type="text" size="15" maxlength="50" name="hotspotname"  value="<?= $hotspotname; ?>" required="1"/></td>
	</tr>
	<tr>
	<td class="align-middle"><?= $_dns_name ?>  </td><td><input class="form-control" type="text" size="15" maxlength="500" name="dnsname"  value="<?= $dnsname; ?>" required="1"/></td>
	</tr>
	<tr>
	<td class="align-middle"><?= $_currency ?>  </td><td><input class="form-control" type="text" size="3" maxlength="4" name="currency"  value="<?= $currency; ?>" required="1"/></td>
	</tr>
	<tr> 
	<td class="align-middle"><?= $_auto_reload ?></td><td>
	<div class="input-group">
		<div class="input-group-10">
        	<input class="group-item group-item-l" type="number" min="10" max="3600" name="areload"  value="<?= $areload; ?>" required="1"/>
    	</div>
  ...
  <div class="input-group-3">
	...
	<tr>
	<td class="align-middle"><?= $_traffic_interface ?></td><td><input class="form-control" type="number" min="1" max="99" name="iface"  value="<?= $iface; ?>" required="1"/></td>
	</tr>

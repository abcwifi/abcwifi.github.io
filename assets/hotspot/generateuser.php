...
<div class="card box-bordered">
	...
	<h3><i class="fa fa-user-plus"></i> Cetak Manual <small id="loader" style="display: none;" ><i><i class='fa fa-circle-o-notch fa-spin'></i> <?= $_processing ?> </i></small></h3> 
	</div>
	<div class="row">
...
<?php if(isset($qpid)){echo "
  ...
  <tr>
	...
	<tr>
    <td class="align-middle">Mode</td><td>

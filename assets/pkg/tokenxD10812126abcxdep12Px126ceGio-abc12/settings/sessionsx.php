      ...
      <div class="card-body">
        <div class="row">
          <div class="col-6">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><i class="fa fa-server"></i> <?= VOUCHER ?></h3>
              </div>
            <div class="card-body">
            <div class="row">
              <?php
                        ...
                        <div class="box bmh-75 box-bordered <?= $color[rand(1, 11)]; ?>">
                                <div class="box-group">
                                  ...
                                  <div class="box-group-area">
                                    <span>
                                      <span class="connect pointer"  id="<?= $value; ?>"><i class="fa fa-external-link"></i> Print & Cek Voucher</span>&nbsp;
          ...
          <form autocomplete="off" method="post" action="">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><i class="fa fa-user-circle"></i> <?= setting ?></h3>
              </div>
            <div class="card-body">
      <table class="table table-sm">
        <tr>
          <td class="align-middle"><?= Router ?> </td><td><input class="form-control" id="useradm" type="text" size="10" name="useradm" title="User Admin" value="<?= $useradm; ?>" required="1"/></td>
        </tr>
        <tr>
...
<a href="./admin.php?id=settings&session=<?= $value; ?>"><i class="fa fa-edit"></i> <?= setting ?></a>&nbsp;
    </div>
    </div>
    </form>
  </div>

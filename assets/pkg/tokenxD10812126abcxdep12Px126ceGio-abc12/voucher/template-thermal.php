...
<!-- Logo Hotspotname -->
    <tr>
      <td style="text-align: left; font-size: 14px; font-weight:bold; border-bottom: 1px black solid;"><center>WiFi Voucher <?= $hotspotname; ?>  <span id="num"><?= " [$num]"; ?></span></td>
    </tr>
<!-- /  -->
    <tr>
      <td>
...
<!-- /  -->
    <tr>
      <!-- Note  -->
      <td colspan="2" style="border-top: 1px solid black;font-weight:bold; font-size:12px">Login: http://<?= $dnsname; ?></td>
<!-- /  -->
    </tr>
    <tr>
      <!-- Price  -->
      <td colspan="2" style="font-weight:bold; font-size:13px"><?= $validity; ?><?= $price; ?></td>
<!-- /  -->
    </tr>
<!-- /  -->
  </tbody>
